...
public class UnityHelper : MonoBehaviour
{
    /// <summary>
        ...
        /// <returns></returns>
        public static T FindTheParentNode<T>(GameObject goChild) where T : Component
        {
            T searchTrans = null;                   //查找结果

            searchTrans = goChild.GetComponent<T>();
            if (searchTrans == null)
            {
                return FindTheParentNode<T>(goChild.transform.parent.gameObject);
            }
            return null;
        }
